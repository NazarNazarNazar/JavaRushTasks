    ...
    public static void sort(List<Stock> list) {
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                String stock01 = (String) stock1.get("name");
                String stock02 = (String) stock2.get("name");
                int value = stock01.compareTo(stock02);
                if (value != 0) {
                    return value;
                } else {
                    long date1 = ((Date) stock1.get("date")).getTime() / 86400000;
                    long date2 = ((Date) stock2.get("date")).getTime() / 86400000;
                    if ((date1 - date2) != 0)
